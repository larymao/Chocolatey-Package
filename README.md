...
**UTC**: 2017-06-21 00:31 [![](http://transparent-favicon.info/favicon.ico)](#) [](https://github.com/)
...
Finished 29 packages after .86 minutes.  
...
|<img src="https://cdn.rawgit.com/echizenryoma/Chocolatey-Package/master/filevista/filevista.png" width="32" height="32"/>|[filevista](https://chocolatey.org/packages/filevista/7.10.0.0)|[True](#filevista) &#x1F538;|False|[7.10.0.0](https://www.gleamtech.com/filevista)|[7.9.12.0](https://github.com/echizenryoma/Chocolatey-Package/tree/master/filevista)|
...
Updating files
  $Latest data:
    FileType        (String)    zip
    NuspecVersion   (String)    7.9.12.0
    PackageName     (String)    filevista
    URL32           (String)    https://www.gleamtech.com/downloads/FileVista-v7.10.0.0-Installer.zip
    Version         (String)    7.10.0.0

  filevista.nuspec
    setting id:  filevista
updating version: 7.9.12.0 -> 7.10.0.0
  tools\chocolateyInstall.ps1
    (^[$]url\s*=\s*)('.*') = $1'https://www.gleamtech.com/downloads/FileVista-v7.10.0.0-Installer.zip' 
Attempting to build package from 'filevista.nuspec'.
Successfully created package 'D:\Project\Chocolatey-Package\filevista\filevista.7.10.0.0.nupkg'
Package updated
```
