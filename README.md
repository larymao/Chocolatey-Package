...
**UTC**: 2017-06-19 00:00 [![](http://transparent-favicon.info/favicon.ico)](#) [](https://github.com/)
...
Finished 29 packages after .71 minutes.  
...
|<img src="https://cdn.rawgit.com/echizenryoma/Chocolatey-Package/master/filevista/filevista.png" width="32" height="32"/>|[filevista](https://chocolatey.org/packages/filevista/7.9.12.0)|[False](#filevista)|False|[7.9.12.0](https://www.gleamtech.com/filevista)|[7.9.12.0](https://github.com/echizenryoma/Chocolatey-Package/tree/master/filevista)|
...
|<img src="https://cdn.rawgit.com/chocolatey/chocolatey-coreteampackages/136ef0bb871e04da4d9e0e0da37902930c80c2b4/icons/notepadplusplus.png" width="32" height="32"/>|[notepadplusplus.portable](https://chocolatey.org/packages/notepadplusplus.portable/7.4.2)|[True](#notepadplusplus.portable) &#x1F538;|False|[7.4.2](https://notepad-plus-plus.org/)|[7.4.1](https://github.com/echizenryoma/Chocolatey-Package/tree/master/notepadplusplus.install)|
...
Updating files
  $Latest data:
    NuspecVersion   (String)    22.1.6372
    PackageName     (String)    database.net.free
    Version         (String)    22.2.6379

  database.net.free.nuspec
    setting id:  database.net.free
updating version: 22.1.6372 -> 22.2.6379
  tools\chocolateyInstall.ps1
Attempting to build package from 'database.net.free.nuspec'.
Successfully created package 'D:\Project\Chocolatey-Package\database.net.free\database.net.free.22.2.6379.nupkg'
Package updated
```
...
nuspec version: 7.9.12.0
remote version: 7.9.12.0
No new version found
```
...
Updating files
  $Latest data:
    Checksum32      (String)    8c74caee7ce09b85604701e36effeb62a9daa69d
    ChecksumType32  (String)    sha1
    FileType        (String)    7z
    NuspecVersion   (String)    7.4.1
    PackageName     (String)    notepadplusplus.portable
    URL_EXTRA       (String)    https://notepad-plus-plus.org/repository/7.x/7.4.2/npp.7.4.2.Installer.exe
    URL32           (String)    https://notepad-plus-plus.org/repository/7.x/7.4.2/npp.7.4.2.bin.7z
    Version         (String)    7.4.2

  notepadplusplus.portable.nuspec
    setting id:  notepadplusplus.portable
updating version: 7.4.1 -> 7.4.2
  tools\chocolateyInstall.ps1
    (^[$]checksumType\s*=\s*)('.*') = $1'sha1' 
    (^[$]urlExtra\s*=\s*)('.*') = ${1}'https://notepad-plus-plus.org/repository/7.x/7.4.2/npp.7.4.2.Installer.exe' 
    (^[$]url\s*=\s*)('.*') = $1'https://notepad-plus-plus.org/repository/7.x/7.4.2/npp.7.4.2.bin.7z' 
    (^[$]checksum\s*=\s*)('.*') = $1'8c74caee7ce09b85604701e36effeb62a9daa69d' 
Attempting to build package from 'notepadplusplus.portable.nuspec'.
Successfully created package 'D:\Project\Chocolatey-Package\notepadplusplus.portable\notepadplusplus.portable.7.4.2.nupkg'
Package updated
```
