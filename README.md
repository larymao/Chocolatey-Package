...
**UTC**: 2017-06-28 00:00 [![](http://transparent-favicon.info/favicon.ico)](#) [](https://github.com/)
...
|<img src="https://cdn.rawgit.com/echizenryoma/Chocolatey-Package/master/git.portable/git.svg" width="32" height="32"/>|[git.portable](https://chocolatey.org/packages/git.portable/2.13.2)|[True](#git.portable) &#x1F538;|False|[2.13.2](https://git-for-windows.github.io/)|[2.13.1.2](https://github.com/echizenryoma/Chocolatey-Package/tree/master/git.portable)|
...
nuspec version: 22.2.6387
remote version: 22.2.6387
No new version found
```
...
Updating files
  $Latest data:
    FileType        (String)    exe
    NuspecVersion   (String)    2.13.1.2
    PackageName     (String)    git.portable
    URL32           (String)    https://npm.taobao.org/mirrors/git-for-windows/2.13.2.windows.1/PortableGit-2.13.2-32-bit.7z.exe
    URL64           (String)    https://npm.taobao.org/mirrors/git-for-windows/2.13.2.windows.1/PortableGit-2.13.2-64-bit.7z.exe
    Version         (String)    2.13.2

  git.portable.nuspec
    setting id:  git.portable
updating version: 2.13.1.2 -> 2.13.2
  .\tools\chocolateyInstall.ps1
    (^[$]url64\s*=\s*)('.*') = $1'https://npm.taobao.org/mirrors/git-for-windows/2.13.2.windows.1/PortableGit-2.13.2-64-bit.7z.exe' 
    (^[$]url32\s*=\s*)('.*') = $1'https://npm.taobao.org/mirrors/git-for-windows/2.13.2.windows.1/PortableGit-2.13.2-32-bit.7z.exe' 
Attempting to build package from 'git.portable.nuspec'.
Successfully created package 'D:\Project\Chocolatey-Package\git.portable\git.portable.2.13.2.nupkg'
Package updated
```
