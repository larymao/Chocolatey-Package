...
**UTC**: 2017-06-12 00:00 [![](http://transparent-favicon.info/favicon.ico)](#) [](https://github.com/)
...
Finished 29 packages after 1.27 minutes.  
...
Updating files
  $Latest data:
    NuspecVersion   (String)    22.0.6367
    PackageName     (String)    database.net.free
    Version         (String)    22.1.6372

  database.net.free.nuspec
    setting id:  database.net.free
updating version: 22.0.6367 -> 22.1.6372
  tools\chocolateyInstall.ps1
Attempting to build package from 'database.net.free.nuspec'.
Successfully created package 'D:\Project\Chocolatey-Package\database.net.free\database.net.free.22.1.6372.nupkg'
Package updated
```
