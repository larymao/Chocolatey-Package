...
**UTC**: 2017-06-17 00:00 [![](http://transparent-favicon.info/favicon.ico)](#) [](https://github.com/)
...
Finished 29 packages after .88 minutes.  
...
|<img src="https://cdn.rawgit.com/echizenryoma/Chocolatey-Package/master/git.portable/git.svg" width="32" height="32"/>|[git.portable](https://chocolatey.org/packages/git.portable/2.13.1.2)|[True](#git.portable) &#x1F538;|False|[2.13.1.2](https://git-for-windows.github.io/)|[2.13.1](https://github.com/echizenryoma/Chocolatey-Package/tree/master/git.portable)|
...
Updating files
  $Latest data:
    FileType        (String)    exe
    NuspecVersion   (String)    2.13.1
    PackageName     (String)    git.portable
    URL32           (String)    https://npm.taobao.org/mirrors/git-for-windows/2.13.1.windows.2/PortableGit-2.13.1.2-32-bit.7z.exe
    URL64           (String)    https://npm.taobao.org/mirrors/git-for-windows/2.13.1.windows.2/PortableGit-2.13.1.2-64-bit.7z.exe
    Version         (String)    2.13.1.2

  git.portable.nuspec
    setting id:  git.portable
updating version: 2.13.1 -> 2.13.1.2
  .\tools\chocolateyInstall.ps1
    (^[$]url64\s*=\s*)('.*') = $1'https://npm.taobao.org/mirrors/git-for-windows/2.13.1.windows.2/PortableGit-2.13.1.2-64-bit.7z.exe' 
    (^[$]url32\s*=\s*)('.*') = $1'https://npm.taobao.org/mirrors/git-for-windows/2.13.1.windows.2/PortableGit-2.13.1.2-32-bit.7z.exe' 
Attempting to build package from 'git.portable.nuspec'.
Successfully created package 'D:\Project\Chocolatey-Package\git.portable\git.portable.2.13.1.2.nupkg'
Package updated
```
